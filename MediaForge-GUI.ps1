...
function Show-APIKeyDialog {
    ...
    $lblFfHint=New-Object System.Windows.Forms.Label; $lblFfHint.Text="Point to ffmpeg.exe — ffprobe.exe is located in Program Files (x86)/MediaForge/ffmpeg/bin/ffmpeg.exe"
